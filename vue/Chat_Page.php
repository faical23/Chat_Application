...
<input type ="text" value="<?Php echo $_GET['connect']?>" id='FriendId' hidden>
...
<g>
    ...
    <div class="Chat">
		...
		<form onsubmit="return SendGetMsg();">
            <div class="row">
                <div class="col-xxl-1 col-xl-2 col-lg-2 col-md-2 col-2">
...
<g>
					...
					<div class="col-xxl-10 col-xl-8 col-lg-8 col-md-8 col-8" >
						<input type="text" placeholder="Type your message her ..." name="message"  class="send_msg" >
					</div>
					<div class="col-xxl-1 col-xl-1 col-lg-2 col-md-2 col-2">
						<div class="send_msg">
